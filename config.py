...
class Config(object):
    ...
    MAIL_ENABLED = os.environ.get('MAIL_ENABLED') or None
    MAIL_SERVER = os.environ.get('MAIL_SERVER') or '172.17.0.3'
    ...
    POSTS_PER_PAGE = 25
    LANGUAGES = ['en']
    ROCKET_ENABLED = os.environ.get('ROCKET_ENABLED') or None
